...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /workspaces/RobotLearning_Labs/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /workspaces/RobotLearning_Labs/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /workspaces/RobotLearning_Labs/install)
...
if(NOT "/workspaces/RobotLearning_Labs/devel/include;/workspaces/RobotLearning_Labs/src/beginner_tutorials/include " STREQUAL " ")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/workspaces/RobotLearning_Labs/devel/include;/workspaces/RobotLearning_Labs/src/beginner_tutorials/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Peder Raastad Basmo <peder.basmo@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspaces/RobotLearning_Labs/src/beginner_tutorials/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspaces/RobotLearning_Labs/devel/lib;/workspaces/RobotLearning_Labs/devel/lib;/opt/ros/noetic/lib)
